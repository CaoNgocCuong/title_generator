...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-2/4 top-2/4 flex h-80 w-full -translate-x-2/4 -translate-y-2/4 flex-col rounded-none bg-cyan-900 p-3 sm:w-full md:w-2/5 md:rounded-md lg:w-1/4">
